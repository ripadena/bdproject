...
(1, CURRENT_TIMESTAMP - INTERVAL 5 DAY, CURRENT_TIMESTAMP - INTERVAL 5 DAY + INTERVAL 8 MINUTE, 150000, 'WIN'),
(2, CURRENT_TIMESTAMP - INTERVAL 4 DAY, CURRENT_TIMESTAMP - INTERVAL 4 DAY + INTERVAL 5 MINUTE, 40000, 'TAKE'),
(3, CURRENT_TIMESTAMP - INTERVAL 3 DAY, CURRENT_TIMESTAMP - INTERVAL 3 DAY + INTERVAL 4 MINUTE, 0, 'WRONG'),
(4, CURRENT_TIMESTAMP - INTERVAL 2 DAY, CURRENT_TIMESTAMP - INTERVAL 2 DAY + INTERVAL 7 MINUTE, 80000, 'TAKE'),
(5, CURRENT_TIMESTAMP - INTERVAL 1 DAY, CURRENT_TIMESTAMP - INTERVAL 1 DAY + INTERVAL 3 MINUTE, 5000, 'WRONG');
